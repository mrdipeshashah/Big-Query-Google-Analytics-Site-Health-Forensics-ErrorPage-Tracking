This repository contains Big Query code using Google Analytics raw data tracking error page performance, when a user lands on a 404 error page impacts user experience and in turn potenital revenue loss. 
